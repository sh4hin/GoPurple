...
func RunCreateProcessWithPipe(url string, prog string, args string) {
	...
	*/
	...
	if peHeader.Machine == 34404 { // 0x8664
		...
		log.Fatal(fmt.Sprintf("[!]Unknown IMAGE_OPTIONAL_HEADER type for machine type: 0x%x", peHeader.Machine))
	}
